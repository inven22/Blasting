...
def run_blast_job_update(data):
    try:
        ...
        if id_email_blast:
            ...
            """, (
                nama_email_blast, tanggal_mulai, tanggal_selesai, tahun_lulus,
